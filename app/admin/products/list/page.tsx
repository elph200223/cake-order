...
export default async function AdminProductsPage() {
  ...
  return (
    <main style={{ padding: 16, maxWidth: 980, margin: "0 auto" }}>
      ...
      <div style={{ marginTop: 14, border: "1px solid #e5e5e5", borderRadius: 12, overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
          <thead>
            <tr style={{ background: "#fafafa", textAlign: "left" }}>
              ...
              <th style={{ padding: 12, borderBottom: "1px solid #eee", width: 140 }}>操作</th>
            </tr>
          </thead>
          ...
          <tbody>
            {products.map((p) => (
              <tr key={p.id}>
                ...
                <td style={{ padding: 12, borderBottom: "1px solid #f1f1f1", fontWeight: 700 }}>{p.name}</td>
                <td style={{ padding: 12, borderBottom: "1px solid #f1f1f1", opacity: 0.85 }}>{p.slug}</td>
